        ...
        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <a href="{{ route('public.home') }}" 
              class="block py-2 px-3 md:p-0 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 
                {{ request()->routeIs('public.home') ? 
                  'text-blue-700 text-white bg-blue-700 md:bg-transparent md:dark:bg-transparent md:text-blue-700 md:dark:text-blue-500' : 
          ...
          <li>
            <a href="{{ route('public.about') }}"
               class="block py-2 px-3 md:p-0 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent md:dark:hover:text-blue-500 dark:border-gray-700 
