...
<body class="bg-gray-50 dark:bg-gray-900 dark:text-white">
  ...
  <main class="py-8 mt-16"> <!-- Added mt-16 to prevent content from overlapping the navbar -->
    {{ $slot }}
  </main>
