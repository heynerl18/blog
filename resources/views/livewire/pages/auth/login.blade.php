...
<section class="bg-gray-50 dark:bg-gray-900 min-h-screen">
  <div class="flex flex-col items-center justify-center px-4 py-8 mx-auto min-h-screen">
    ...
    <!-- Login Card with Overlapping Logo -->
    <div class="w-full max-w-md relative">
      ...
      <!-- Card form -->
      <div class="bg-white rounded-lg shadow-md dark:border dark:bg-gray-800 dark:border-gray-700 pt-10">
            ...
            <div class="flex items-center justify-between text-sm">
              <div class="flex items-center">
                <input 
                  ...
                  id="remember" 
                  type="checkbox" 
                  class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
                  wire:loading.attr="disabled"
                >
