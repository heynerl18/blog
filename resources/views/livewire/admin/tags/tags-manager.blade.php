  ...
  <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
    <div class="w-full mb-1">
      <div class="mb-4">
          ...
          <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="#" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Etiquetas</a>
              </div>
            </li>
            <li>
              <div class="flex items-center">
        ...
        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Todas las etiquetas</h1>
      </div>
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center w-full sm:w-auto sm:divide-x sm:divide-gray-100 dark:divide-gray-700">
          <div class="lg:pr-3 w-full lg:w-auto">
            <label for="tags-search" class="sr-only">Buscar</label>
                ...
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                  <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                    ...
                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                      <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $tag->id }}</div>
                    </div>
                  </td>
                  <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{{ $tag->name }}</td>
                  <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">{{ $tag->slug }}</td>
                  <td class="p-4 space-x-2 whitespace-nowrap">
                    @can('tags.edit')
                      <button 
                        type="button" 
                        x-on:click="$dispatch('openModal', { tagId: {{ $tag->id }} })"
                    ...
                    @can('tags.destroy')
                      <button 
                        type="button" 
                        x-on:click="$dispatch('openModalDelete', { tagId: {{ $tag->id }} })"
