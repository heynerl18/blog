...
<div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
    <label for="posts-editor" class="sr-only">Publish post</label>
    <div id="posts-editor" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 max-h-96 overflow-y-auto"></div>
</div>
</div>
