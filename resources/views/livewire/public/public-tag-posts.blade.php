        ...
        <ul class="space-y-8">
            @foreach ($posts as $post)
                ...
                <li class="rounded-lg shadow-md overflow-hidden bg-white dark:bg-gray-800 transition transform hover:-translate-y-1 hover:shadow-xl animate-fade-in duration-300">
                    ...
                    @else
                        {{-- Si no hay video ni imagen, muestra el encabezado con el ícono y mejores colores --}}
                        <div class="relative w-full h-64 rounded-t-lg overflow-hidden bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
                            <svg class="w-24 h-24 text-gray-400 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
