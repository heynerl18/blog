@php
  // Declarar la variable $page_slug directamente en la vista
  $url = explode('/', request()->path()); // Obtener la URL actual y dividirla en segmentos
  $page_slug = end($url); // Obtener el último segmento de la URL como el slug
@endphp
